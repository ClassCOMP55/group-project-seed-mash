...
public class GameLevel {
    ...
    public static final String[] GREAT_FAIRY_FOUNTAIN_GEOM = {
		    "                                               BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB   BBBBBBBB   BBBBBBBBBBBBBBBBB   BBBBBBBBBBBBBBBBBBB                                                                                                                                                                          ",
		    "                                               BBBBBBBBBBBBBBBBBBBBBBBB                                                                                                                                                                                                                                                ",
		    "                                               BBBBBBBBBBBBBBBBBBBB                                                                                                      ^                                      ^                                                  ^                                                   ",
		    "   B B                                         BBBBBBBBBBBBBBBB                                                                                                          v                 B------------B                                -                                             B---------B                     ",
		    "   BBB                                         BBBBBBBBBBBBBBBB                                                                                                                       ^B--BB            B         ^                                ^                        B----B               B         ---         ",
		    "   B B                  B             B        BBBBBBBBBBBB               B              B          B                   B                   B   B------B   B    ----  B----B          BB   B            B    B----B   B                 B-B                BB--B            B    B               B    ^B---B B         ",
